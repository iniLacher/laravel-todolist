...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <p class="col-lg-10 fs-4">by <a target="_blank" href="https://sweet-dieffenbachia-db9fb2.netlify.app/">Programmer King Abdi</a></p>
        </div>
                ...
                <tbody>
                  @foreach ($todolist as $todo)
                    <tr>
                      ...
                      <td>{{ $todo['todo'] }}</td>
                      <td>
                        <form action="/todolist/{{ $todo['id'] }}/delete" method="post" id="deleteForm">
                          @csrf
